	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'techmix_review' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'techmix_review' ); ?></th>
			</tr>
		</thead>
		<tbody>
